         ...
         <div className="container">
            <div className="header__inner">
               ...
               <ul ref={navRef} className={activeNav ? 'list active' : 'list'}>
                  ...
                  <li>
                     <Link to="/courses" onClick={() => setActiveNav(false)}>
                        Курсы
                     </Link>
                  </li>
                  <li>
                     <Link to="/community" onClick={() => setActiveNav(false)}>
                        «Мысль»
                     </Link>
                  </li>
                  <li>
                     <Link to="/biography" onClick={() => setActiveNav(false)}>
                        Биография
                     </Link>
                  </li>
                  <li>
                     <Link to="/social-media" onClick={() => setActiveNav(false)}>
                        Социальные сети
                     </Link>
                  </li>
                  <li>
                     <Link to="/feedbacks" onClick={() => setActiveNav(false)}>
                        Отзывы
                     </Link>
                  </li>
                  <li className="btn-order">
                     <Link className="btn" to="/registration" onClick={() => setActiveNav(false)}>
                        Записаться
                     </Link>
                  </li>
                  <li className="close">
