...
import { coursesGroupData, coursesIndividualData, coursesOriginalData } from '../../../../../data';
import { Link, useLocation } from 'react-router-dom';
import { COURSE_GROUP_PATHNAME, COURSE_INDIVIDUAL_PATHNAME, COURSE_ORIGINAL_PATHNAME } from '../../../../../const';
                ...
                <div className="course-page__inner">
                    ...
                    <section className="course-page__info section__box">
                        ...
                        <div className='course-page__inner-img'>
                            <img className='img' src={courseData.img} alt={courseData.imgAlt} />
                        </div>
                    </section>
                    <section className="course-page__programm section__box">
                        {
                            pathName === COURSE_ORIGINAL_PATHNAME
                                ...
                                : <div className='course-page__programm-img'>
                                    <img className='img' src={coursesImg} alt="курсы по философии" />
                                </div>
                        }

                        <ol className={pathName === COURSE_ORIGINAL_PATHNAME ? 'course-page__programm-list-grid' : 'course-page__programm-list'}>
                            {courseData.programm.map(arrayItem => {
                                if (pathName === COURSE_ORIGINAL_PATHNAME) {
                                    return (
                                        <li className='course-page__programm-list-grid-item' key={arrayItem.id}>
                    ...
                    </section>
                    {
                        pathName === COURSE_ORIGINAL_PATHNAME
                            ?
                            <section>
                                <h4>На самом деле тут не все темы, а скорее те которые я вспомнил и смог как-то назвать) <br /> Так что в любом случае уточняйте в телеграме.</h4>
                            </section>
                            : null
                    }
