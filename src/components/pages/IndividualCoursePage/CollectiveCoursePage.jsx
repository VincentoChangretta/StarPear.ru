         ...
         <div className="container">
            <div className="course-inner">
               ...
               <div className="course-title-box">
                  <h2>Коллективный формат проведения</h2>
               ...
               <div className="course-questions">
                  ...
                  <div className="text">
                     ...
                     <ol className="gic__list">
                        ...
                        <li>
                           В среднем занятие длится 1.5 часа, и проходит один раз в неделю. При желании занятия также
                           можно проводить два раза в неделю.
                        </li>
               ...
               <div className="text">
                  <h4>Цены:</h4>
                  <ol className="gic__list">
                     <li>Цена одного занятия в коллективном слоте - 1000₽</li>
                     <li>При оплате от четырех занятий включительно скидка 10%, вы заплатите не 4000₽ а 3600₽</li>
                     <li>
