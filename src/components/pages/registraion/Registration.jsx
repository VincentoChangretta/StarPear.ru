         ...
         <div className="container">
            <div className="registration__inner">
               ...
               <form
                  ref={formRef}
                  onSubmit={e =>
                     handleSubmit(e, formRef.current, setFetchDescr, isCheckedPrivacy, sendError, setSendError)
                  }
               >
                  ...
                  <div className="form__inputs">
                     ...
                     <p className={fetchDescr ? 'fetch-success-description active' : 'fetch-success-description'}>
